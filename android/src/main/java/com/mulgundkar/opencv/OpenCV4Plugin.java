        ...
        switch (call.method) {
            ...
            case "warpPerspectiveTransform":
                result.success(core.warpPerspectiveTransform((byte[]) call.argument("byteData"),
                        (ArrayList) call.argument("sourcePoints"), (ArrayList) call.argument("destinationPoints"), (double) call.argument("xOffset"), (double) call.argument("yOffset"), (double) call.argument("scaleFactor"), (ArrayList) call.argument("outputSize") ));
                break;
            default:
